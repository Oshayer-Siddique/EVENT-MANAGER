...
public class HybridLayoutDTO {
    ...
    @Builder.Default private List<SectionDefinition> sections = new ArrayList<>();
    @Builder.Default private List<ElementDefinition> elements = new ArrayList<>();
    @Builder.Default private List<SeatDefinition> seats = new ArrayList<>();
